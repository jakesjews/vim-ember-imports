...
call JSAddImportDefinition({'name': 'Component', 'default': 0, 'from': '@glimmer/component'})
...
call JSAddImportDefinition({'name': 'RESTAdapter', 'default': 1, 'from': '@ember-data/adapter/rest'})
call JSAddImportDefinition({'name': 'JSONAPIAdapter', 'default': 1, 'from': '@ember-data/adapter/json-api'})
call JSAddImportDefinition({'name': 'JSONSerializer', 'default': 1, 'from': '@ember-data/serializer/json'})
call JSAddImportDefinition({'name': 'RESTSerializer', 'default': 1, 'from': '@ember-data/serializer/rest'})
call JSAddImportDefinition({'name': 'JSONAPISerializer', 'default': 1, 'from': '@ember-data/serializer/json-api'})
call JSAddImportDefinition({'name': 'Store', 'default': 1, 'from': '@ember-data/store'})
call JSAddImportDefinition({'name': 'Transform', 'default': 1, 'from': '@ember-data/serializer/transform'})
call JSAddImportDefinition({'name': 'attr', 'default': 0, 'from': '@ember-data/model'})
call JSAddImportDefinition({'name': 'hasMany', 'default': 0, 'from': '@ember-data/model'})
call JSAddImportDefinition({'name': 'belongsTo', 'default': 0, 'from': '@ember-data/model'})
